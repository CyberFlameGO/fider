...
export const approveUser = async (userID: number): Promise<Result> => {
  return await http.put(`/_api/admin/users/${userID}/approve`)
}

export const unapproveUser = async (userID: number): Promise<Result> => {
  return await http.delete(`/_api/admin/users/${userID}/approve`)
}
